...
def homepage():
    ...
    st.markdown("<h7 style='text-align: left; color: black; font-size: 15px;'>Below are three photos of myself generated by AI. Do you like them? ( ͡° ͜ʖ ͡° )</h7>", unsafe_allow_html=True)
    st.image(jasmine_homepage_6)
    st.image(jasmine_homepage_1)
    st.image(jasmine_homepage_5)

    st.write("______________________")
    st.markdown("<h7 style='text-align: left; color: black; font-size: 15px;'>Below are my parents, Lauren & Alan! ꒰(･‿･)꒱</h7>", unsafe_allow_html=True)
    st.markdown("<h7 style='text-align: left; color: black; font-size: 15px;'>My dad is an IT business analyst who built this web application from scratch and my mum is a registered nurse. </h7>", unsafe_allow_html=True)
    st.markdown("<h7 style='text-align: left; color: black; font-size: 15px;'>They met each other in CUHK and below is a picture of them taken in Japan.</h7>", unsafe_allow_html=True)
    st.markdown(
        """
    ...
    st.write("______________________")
    st.markdown("<h7 style='text-align: left; color: black; font-size: 15px;'>Besides, I have got 2 friends already, Chak Gucci and Chak Mui and they love each other! ༼♥ل͜♥༽</h7>", unsafe_allow_html=True)
    st.markdown(
        """
        <div style='display: flex; align-items: center;'>
    ...
    st.write("______________________")
    st.markdown("<h6 style='text-align: left;'>Below charts show my growth trend, you can visit tab 'Growth Record' to review the details inclucing statistical and regression analysis.</h6>", unsafe_allow_html=True)
...
def album():
    ...
    st.markdown("<h7 style='text-align: left; color: black; font-size: 15px;'>Select a collection via the dropdown list below:</h7>", unsafe_allow_html=True)
