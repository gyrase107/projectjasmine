...
def homepage():
    ...
    st.markdown("<h7 style='text-align: left; color: dark blue; font-size: 15px;'></h7>", unsafe_allow_html=True)
    st.markdown("<h7 style='text-align: left; color: dark blue; font-size: 15px;'>Below are three photos of myself generated by AI. Do you like them? ( ͡° ͜ʖ ͡° )</h7>", unsafe_allow_html=True)
